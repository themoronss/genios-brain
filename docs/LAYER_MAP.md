...
| *(future `executive/`)* | 5 | Executive Intelligence | — | Decision briefs, verbs, alternatives, prediction, explanation. Today it lives inside `reason/intelligence.py` + `deliver/card_builder.py`; extracted additively when the split lands. |
