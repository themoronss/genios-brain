...
DORMANT_LANES: dict[str, str] = {
    ...
    "cohort":
        ...
        "construction, so no two people can ever share one. Measured across all 210 objectives "
        "after the backfill: every group has exactly ONE person, against a `_MIN_COHORT` of 3. "
