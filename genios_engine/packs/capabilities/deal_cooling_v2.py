...
def build_deal_cooling_full_manifest() -> CapabilityManifest:
    ...
    return CapabilityManifest(
        ...
        # Delivery-enabled. This is the flag the authority predicate reads out of the frozen
        # manifest bytes (`rcap.manifest->'live_delivery_enabled'`), so flipping it changes the
        # capability's content address — correct and intended, because a capability that may reach
        # a human is not the same capability as one that may not.
